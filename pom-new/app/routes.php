...
//Admin Logout
Route::get('/logout',array('uses'=>'admin\\AdminLogoutController@Adminlogout'));
...
//for comment show on po-overview
Route::get('po-comment-page/{id}',array('as'=>'po-comment-page','uses'=>'pmofrontend\\PoController@po_cmt_show'));
//booking confirmation send 3/3/16 

Route::get('send-for-conf-booking/{id}',array('as'=>'send-for-conf-booking','uses'=>'pmofrontend\\PobookingController@booking_confirmation_send'));
Route::post('booking-conf-send',array('as'=>'booking-conf-send','uses'=>'pmofrontend\\PobookingController@confirm_booking'));
Route::get('booking-comment-page/{id}',array('as'=>'booking-comment-page','uses'=>'pmofrontend\\PobookingController@booking_cmt_show'));