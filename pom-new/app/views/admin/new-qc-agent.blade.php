...
<!--            <tr>
      ...
      <a href="<?php echo URL::to('qc-agent'); ?>"><button aria-label="Left Button" class="btn btn-danger btn-sm pull-right backbutt" id="button2id" type="button"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back </button></a>
      </div>
    <?php {{ Form::close(); }}?>
  </div>
  <!-- Row End --> 
