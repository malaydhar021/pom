...
@include('admin.includes.sidebar')      
    ...
    <form class="form-horizontal">
      ...
      <div class="form-group firstnamer">
        ...
        <div class="col-md-8">
          <span class="valler">{{ $qc_detail[0]->QCAGENT_NAME}}</span>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
        <span class="valler">{{ $qc_detail[0]->QCAGENT_EMAIL}}</span>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <span class="valler">{{ $qc_detail[0]->QCAGENT_COMPANY_NAME}}</span>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-8">
          <span class="valler">
          <div style="line-height:20px;">{{$qc_detail[0]->QCAGENT_ADDRESS}}</div></span>
        </div>
      </div>
      </div>
      <div class="col-sm-4">
      <div class="form-group">
        ...
        <div class="col-md-8">
          <span class="valler">{{ $qc_detail[0]->CNT_NICENAME}}</span>
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-4 control-label" for="Zip">Zip </label>
        <div class="col-md-8">
         <span class="valler">{{ $qc_detail[0]->QCAGENT_ZIP}}</span>
        </div>
      </div>
      </div>
      <!-- Multiple Checkboxes -->
...
<div class="form-group">
  <div class="text-right col-sm-10 pull-right">
    <div id="button1idGroup" class="btn-group" role="group" aria-label="Button Group">
      ...
      <a href="<?php echo URL::to('/edit-qc-agent');?>/{{ $qc_detail[0]->QCAGENT_ID}}"><button type="button" id="button2id" name="button2id" class="btn btn-success btn-sm" aria-label="Left Button" >Edit <span class="glyphicon glyphicon-pencil"></span></button></a>
    </div>
      </div>
      </div>
            </div>
