...
<form class="form-horizontal" method="POST">
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input id="customer_name"   maxlength="100"  name="customer_name" type="text" placeholder="Forwarder Name" class="form-control input-md" value="{{$data->FWDR_NAME}}" required>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <input type="text" disabled class="form-control input-md" value="{{$data->FWDR_EMAIL}}">
        
          <input id="email" maxlength="100" name="email" type="hidden" placeholder="Email ID" class="form-control input-md" value="{{$data->FWDR_EMAIL}}" required>
        </div>
      </div>
      </div>
      <div class="col-sm-4">
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input id="cname" maxlength="100"  name="company_name" type="text" placeholder="Company Name" value="{{$data->FWDR_COMPANY_NAME}}" class="form-control input-md" required>
        </div>
      </div>
      <div class="form-group">
        <label class="col-md-4 control-label" for="Address">Address </label>
        <div class="col-md-8">
          <textarea id="Address" name="cust_address" placeholder="Address" class="form-control input-md" required>{{$data->FWDR_ADDRESS}}</textarea>
        </div>
      </div>
      </div>
      <div class="col-sm-4">
      <div class="form-group">
        ...
        <div class="col-md-8">
          <select class="form-control input-md" name="cust_country" id="Country" required>
           @foreach($country as $country_name)
              
              <option value='{{$country_name->CNT_ID}}' <?php if($country_name->CNT_ID == $data->FWDR_COUNTRY) echo 'selected';?> >{{$country_name->CNT_NICENAME}}</option>
      ...
      <div class="form-group">
        ...
        <div class="col-md-8">
          <input id="Zip" name="cust_zip" type="text" placeholder="Zip" value="{{$data->FWDR_ZIP}}" class="form-control input-md" maxlength="10" onKeyPress="return numbersonly(event);" required>
        </div>
      </div>
      </div>
      @endforeach
  ...
  <div class="text-right col-sm-10 pull-right">
    <div id="button1idGroup" class="btn-group" role="group" aria-label="Button Group">
      ...
      <button type="submit" id="save_button" name="button2id" class="btn btn-success btn-sm" aria-label="Left Button">Save <span class="glyphicon glyphicon-floppy-disk"></span></button>
    </div>
      </div>
      </div>
      </div>
