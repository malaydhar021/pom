...
@endif
  ...
  {{Form::open(array('role'=>'form','id'=>'customer_regs_form','class'=>'form-horizontal','method'=>'POST','route'=>'customer-creater','files' => 'false'))}}
    ...
    <!-- Text input-->
    <div class="col-sm-4">
      <div class="form-group"> <?php echo Form::label('customer_name', 'Name', array('class' => 'col-md-4 control-label'));?>
    ...
    <div class="col-sm-4">
      <div class="form-group"> <?php echo Form::label('company_name', 'Company', array('class' => 'col-md-4 control-label'));?>
...
<!-- from validation --> 
<script src="<?php echo URL::to('/'); ?>/backend/custom-js/customer_validation.js"></script> 
