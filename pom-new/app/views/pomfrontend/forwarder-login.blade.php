...
@endif
      <section class="login-form"> 
        <form method="POST" action="forwarder-login" role="login">
          <img src="<?php echo URL::to('/');?>/frontend/img/RcmcLv4.png" class="img-responsive" alt="" />
          <input type="text" name="user_name" placeholder="Email" required class="form-control input-lg" required/>
     ...
     <input type="password" class="form-control" id="password" name='password' placeholder="Password" required>      
          ...
          <button type="submit" name="forwarder_submit" class="btn btn-lg btn-primary btn-block">Sign in</button>
          <div>
