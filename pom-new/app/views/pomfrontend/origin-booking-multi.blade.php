  ...
  <div class="container">
    <div class="row">
        ...
        <ul class="top-menu">
          ...
          <li class="active"><a href="<?php echo URL::to('create-booking'); ?>">Create Booking</a></li>
...
<div class="spacer"></div>
    ...
    <form name="select_po" action="<?php echo URL::to('origin_booking_multi'); ?>" method="post">
    <div class="over-flow-scroll">
      ...
      <div class="over-flow-scroll">
        <table class="table">
        <!--<tr>
          <td style="width:680px;display:block;">
		...
		?>
        <option value='<?php echo $tran->TRANSPORT_MODE_ID; ?>'> <?php echo $tran->TRANSPORT_MODE_NAME; ?></option>
        <?php } ?>
		...
		?>
        <option value='<?php echo $ship->SHIPPING_MODE_ID; ?>'> <?php echo $ship->SHIPPING_MODE_NAME; ?> </option>
        <?php } ?>
       </select></td>
        <td>
        ...
        <option value='<?php echo $inco->INCOTERM_ID; ?>'> <?php echo $inco->INCOTERM_NAME; ?> </option>
        <?php } ?>
        </select></td>
        <td><input type="text" name="pickup_place" value="" required></td>
        <td><input type="text" value="" name="pol" required></td>
        <td><input type="text" value="" name="pod" required></td>
        <td><input type="text" value="" name="delibery_place" required></td>
        <td><input type="text" class="datepicker" name="booking_date" value="" required></td>
        <td><input type="text" class="datepicker" name="res_date" value="" required></td>
        </tr>
        </table></td>
        </tr>
      </table>
    ...
    <a href="#" class="btn btn-success" data-toggle="tooltip" title="Consolidate a Container">Consolidate a Container</a>
     <a href="#" class="btn btn-info" data-toggle="tooltip" title="Get a Rate">Get a Rate</a>
      <a class="btn btn-warning" href="<?php echo URL::to('create-booking');?>" data-toggle="tooltip" title="Cancel / Select another PO">Cancel / Select another PO</a>
      <input type="submit" id='conf_booking' name='conf_booking' class="btn btn-success" value="Create Booking" data-toggle="tooltip" title="Create Booking">    </div>
     </form>
    <br>
...
<script type="text/javascript">
  ...
  $('#conf_booking').click(function(){
    var cbk_val =$('input:checked');
        if(cbk_val.length == 0){
          alert('NO PO  SELECTED FOR BOOKING');
      return false;      
        }
  });
