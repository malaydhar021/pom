...
@endif
    <form name="select_po" action="<?php echo URL::to('origin-booking-multi'); ?>" method="post">
	...
	?>
      ...
      <table class="table">
        ...
        <tr>
          <td><span class="checkbox-box"><input type="checkbox" name="selected_po[]" value="{{$data->PO_ID}}" id="box<?php echo $k; ?>"><label for="box<?php echo $k; ?>"></label></span></td>
...
<div class="text-right">
      ...
      <input class="btn btn-success" id='next_button'  type="submit" value="Next" data-toggle="tooltip" title="Next">    </div>
      </form>
      <br>
