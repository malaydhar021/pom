...
<div class="container">
  <div class="row">
      <div class="col-lg-12">
        <ul class="top-menu">
          <li><a href="<?php echo URL::to('supplier'); ?>">Supplier Overview</a></li>
          <li class="active"><a href="<?php echo URL::to('new-supplier'); ?>">New Supplier</a></li>
        </ul>
      </div>
    </div>
    </div>
...
{{ Session::get('success') }}
@endif  
      {{Form::open(array('role'=>'form','id'=>'customer_regs_form','class'=>'form-horizontal','method'=>'POST','route'=>'new-supplier-create','files' => 'false'))}}
	<?php //echo Form::open(array('action' => '','id'=>'customer_regs_form','class'=>'form-horizontal'));?>
      <!-- Text input-->
      <div class="col-sm-4">
      <div class="form-group">
	  	<?php echo Form::label('customer_name', 'Supplier Name', array('class' => 'col-md-4 control-label'));?>        
        <div class="col-md-8">
