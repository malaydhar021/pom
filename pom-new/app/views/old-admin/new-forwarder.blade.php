...
<header>
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <ul class="top-menu">
          <li><a href="<?php echo URL::to('forwarder'); ?>">Forwarder Overview</a></li>
          <li class="active"><a href="<?php echo URL::to('new-forwarder'); ?>">New Forwarder</a></li>
        </ul>
      </div>
    </div>
  </div>
...
@endif
	...
	<?php //echo Form::open(array('action' => '','id'=>'customer_regs_form','class'=>'form-horizontal'));?>
      ...
      <div class="form-group">
	  	<?php echo Form::label('customer_name', 'Forwarder Name', array('class' => 'col-md-4 control-label'));?>        
        <div class="col-md-8">
